...
var action = 1
var originalOrganization = document.getElementById('food-table').innerHTML
...
function sortByCalories() {
  if (action == 1) {
    ...
    var descDivCollection = document.getElementsByClassName("row food")
    var descArray = []
    for (var i = descDivCollection.length >>> 0; i--;) {
      descArray[i] = descDivCollection[i]
    }
